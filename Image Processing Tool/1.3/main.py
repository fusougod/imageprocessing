...
class ImageProcessorApp:
    ...
    def create_widgets(self):
        ...
        self.grayscale_entry = tk.Entry(self.sliders_frame, width=6)
        ...
        self.blur_entry = tk.Entry(self.sliders_frame, width=6)
        ...
        self.contrast_entry = tk.Entry(self.sliders_frame, width=6)
        ...
        self.brightness_entry = tk.Entry(self.sliders_frame, width=6)
        ...
        self.sharpen_entry = tk.Entry(self.sliders_frame, width=6)
        ...
        tk.Label(self.sliders_frame, text="Saturation").grid(row=5, column=0, sticky=tk.W, padx=5, pady=1)
        ...
        self.saturation_value = tk.Label(self.sliders_frame, text="0.50")
        self.saturation_value.grid(row=5, column=2, padx=5, pady=1)
        self.saturation_entry = tk.Entry(self.sliders_frame, width=6)
        ...
        tk.Label(self.sliders_frame, text="Edge Enhance").grid(row=6, column=0, sticky=tk.W, padx=5, pady=1)
        ttk.Scale(self.sliders_frame, from_=0, to=5, orient=tk.HORIZONTAL, 
                 variable=self.edge_enhance_var, command=self.apply_filters, length=200).grid(row=6, column=1, padx=5, pady=1)
        self.edge_enhance_value = tk.Label(self.sliders_frame, text="0.00")
        self.edge_enhance_value.grid(row=6, column=2, padx=5, pady=1)
        self.edge_enhance_entry = tk.Entry(self.sliders_frame, width=6)
        ...
        tk.Label(self.sliders_frame, text="Rotation (degrees)").grid(row=7, column=0, sticky=tk.W, padx=5, pady=1)
        ...
        self.rotation_value = tk.Label(self.sliders_frame, text="0")
        self.rotation_value.grid(row=7, column=2, padx=5, pady=1)
        self.rotation_entry = tk.Entry(self.sliders_frame, width=6)
        ...
        tk.Label(self.crop_frame, text="Resolution:").pack(side=tk.LEFT, padx=5)
        self.resolution_menu = ttk.Combobox(self.crop_frame, textvariable=self.resolution_var, values=resolutions, state="readonly", width=15)
        self.resolution_menu.pack(side=tk.LEFT, padx=5)
        tk.Button(self.crop_frame, text="Apply Resize", command=self.resize_image).pack(side=tk.LEFT, padx=5)
    ...
    def resize_image(self):
        if self.image:
            try:
                ...
                # Resize to fit within the selected resolution while maintaining aspect ratio
                self.image = self.original_image.copy()
