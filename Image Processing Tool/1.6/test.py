...
class ImageProcessorApp:
    def __init__(self, root):
        ...
        self.posterize_var = tk.IntVar(value=4)
    ...
    def add_sliders(self, parent):
        ...
        add_slider_row(9, "Posterize Levels (2-8)", self.posterize_var, parent, 2, 8, allow_int=True)
    ...
    def apply_filters_to(self, im):
        ...
        if self.noise_reduction_size_var.get() > 1:
            im = im.filter(ImageFilter.MedianFilter(size=self.noise_reduction_size_var.get()))
    ...
    def shift_hue(self, img, hue_shift):
        ...
        shift = int((hue_shift / 360) * 255)
        np_hsv[...,0] = (np_hsv[...,0] + shift) % 255
